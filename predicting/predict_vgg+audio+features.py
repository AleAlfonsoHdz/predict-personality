...
vgg_audio_features_model.load_weights('vgg_audio_features_model_weights.hdf5') # loading best weights
...
class DataGenerator(Sequence):
    ...
    """
    def __init__(self, list_IDs, labels, images_path, audios_path, batch_size=32, dim=(224, 224), audio_shape=224938, features_shape=37, output_size=5, n_channels=3, shuffle=False):
        """Initialization
    ...
    def __getitem__(self, index):
        ...
        # Generate data
        X_1, X_2, X_3 = self.__data_generation(list_IDs_temp)
        return [X_1, X_2, X_3]
    ...
    def __data_generation(self, list_IDs_temp):
        ...
        X_3 = np.empty((self.batch_size, self.features_shape))
...
np.save('test_IDs_vgg+audio+features', test_IDs)
test_generator = DataGenerator(test_IDs, test_OCEAN_features, images_test_path, audios_test_path)

#--------------------------------------------------------------------------------------------------------------

# Doing predictions
print("[INFO] predicting...")
predictions = vgg_audio_features_model.predict_generator(generator = test_generator, verbose = 1)

print("[INFO] printing predictions...")
print(predictions)

print("[INFO] saving predictions...")
np.save('predictions_vgg+audio+features', predictions) # save