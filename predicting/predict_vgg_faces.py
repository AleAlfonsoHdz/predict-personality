...
vgg_model.load_weights('vgg_faces_weights.hdf5') # loading best weights
...
# data generator prepared for predictions
class DataGenerator(Sequence):
    """Generates data for Keras
    Sequence based data generator. Suitable for building data generator for training and prediction.
    """
    def __init__(self, list_IDs, dataset_path, batch_size=32, dim=(224, 224), output_size=5, n_channels=3, shuffle=False):
        """Initialization
    ...
    def __getitem__(self, index):
        ...
        return X # we only return X for predictions
...
predictions = vgg_model.predict_generator(generator = test_generator, verbose = 1)

print("[INFO] printing predictions...")
print(predictions)

print("[INFO] saving predictions...")
np.save('predictions_vgg', predictions) # save